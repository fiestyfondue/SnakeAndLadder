...
namespace SnakeAndLadder
{
    ...
    {
       internal int PlayGame(int playerPosition, int turn)
       {
        ...
        public void Start()
        {
            ...
            int player; // record new position of both players            //variables 
            ...
            //To make turn for player one and player two creating an infinite loop
